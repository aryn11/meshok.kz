...
(17, 9, 9, 40, '2016-04-23 22:30:49', 0);
...
--
-- Структура таблицы `prices_in_markets`
--

CREATE TABLE `prices_in_markets` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `prices_in_markets`
--

INSERT INTO `prices_in_markets` (`id`, `market_id`, `good_id`, `price`) VALUES
(1, 1, 7, 51),
(2, 2, 7, 52),
(3, 3, 7, 53),
(4, 4, 7, 54),
...
--
-- Индексы таблицы `prices_in_markets`
--
ALTER TABLE `prices_in_markets`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `prices_in_markets`
--
ALTER TABLE `prices_in_markets`
