<?php $queryOrderForB = "select o.id as order_id, o.good_id, o.group_id, o.created_at, o.quantity, o.price, o.is_deleted, g.id, g.created_user_id, g.name as group_name, u.id, u.login, gs.id, gs.name as good_name, gs.type
        ...
        <table class="simple-little-table" cellspacing='0'>
            ...
            <?php while ($rowOrdersB = mysqli_fetch_array($queryOrdersForB)) { ?>
                ...
                <tr>
                    ...
                    <td><?php echo $rowOrdersB['quantity']; ?></td>
                    <td><?php echo $rowOrdersB['price']; ?></td>
                    <td><?php echo $rowOrdersB['login']; ?></td>
